...
public class PointsListScreenShould {

    PointsListPresenter presenter;
    ...
    public void setUp() {
        ...
        presenter = new PointsListPresenter(contentViewMock, modelMock);
    }
    ...
    class PointsListPresenter extends Presenter<PointsModel, PointsListContentView> {

        public PointsListPresenter(PointsListContentView view, PointsModel model) {
            super(view, model);
        }
